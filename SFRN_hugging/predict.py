...
def train(args):
    ...
    #best_ckp_path = 'saved/checkpoint_6_0904_ASAP_set56_test0451_at_epoch9.model'
    best_ckp_path = 'saved/checkpoint_3_1113_SFRNIS_basline_1146_at_epoch16.model'
    DEVICE = args.device
    print(DEVICE)
    ...
    with torch.no_grad():
        ...
        save_results_to_csv(y_true, y_pred, './saved/IS_SFRN_results.csv')
