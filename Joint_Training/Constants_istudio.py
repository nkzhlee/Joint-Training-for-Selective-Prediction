...
TRAIN_FILE_PATH = ['/home/nlp/shared/dataset/SemEval-2013/SCI_3way/Beetle_train.csv']
TEST_FILE_PATH = ['/home/nlp/shared/dataset/SemEval-2013/SCI_3way/Beetle_test_UA.csv']

# TRAIN_FILE_PATH = ['../GPTembeddings/data/ada-002/traindev_withembs.csv']
# TEST_FILE_PATH = ['../GPTembeddings/data/ada-002/test_withembs.csv'] # 1536

# TRAIN_FILE_PATH = ['../GPTembeddings/data/babbage-001/traindev_withembs.csv']
# TEST_FILE_PATH = ['../GPTembeddings/data/babbage-001/test_withembs.csv'] # 2048

# TRAIN_FILE_PATH = ['../GPTembeddings/data/curie-001/traindev_withembs.csv']
# TEST_FILE_PATH = ['../GPTembeddings/data/curie-001/test_withembs.csv'] # 4096

SEP_TOKEN = '[SEP]'
CLS_TOKEN = '[CLS]'

hyperparameters = dict(
    train_id="1128_joint_bert_ro_to_0",
